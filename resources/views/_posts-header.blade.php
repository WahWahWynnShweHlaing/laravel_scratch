                ...
                <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
                    ...
                    <div x-data="{ show : false}" @click.away="show = false">
                        ...
                        <div x-show="show" class="py-2 absolute z-50" style="display : none">
                            <a href="/" class="block text-left px-3 text-sm leading-6 hover:bg-gray-300">ALL
                            </a>
                            ...
                            @endforeach
                            <!-- <a hraf="#" class="block text-left px-3 text-sm leading-6 hover:bg-gray-300">Twa</a>
                            <a hraf="#" class="block text-left px-3 text-sm leading-6 hover:bg-gry-300">Three</a> -->
                        </div>
                    </div>
